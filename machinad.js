...
var makeMonadWithAlternative = function(m_, bind_, alt_, ret_) {
    ...
    var disregard = function(f1, f2) {
        return f1.then(function(a) { bind(f2, ret(a)); return ret(a); });
    };
...
(function() {
    ...
    /* not could be generic from alternative but it becomes shit perf */
    this.not = function(f) {
        return function(a) {
            var result = f(a);
            return result.m === Success ? failure(result.a) : success(result.a);
        };
    };
})();
